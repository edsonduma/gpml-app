...
class MakeupArtistsCreateScreen extends StatefulWidget {
  const MakeupArtistsCreateScreen({super.key});

  @override
  State<MakeupArtistsCreateScreen> createState() =>
      _MakeupArtistsCreateScreenState();
}

class _MakeupArtistsCreateScreenState extends State<MakeupArtistsCreateScreen> {
                  ...
                  child: Column(
                    children: [
                        ...
                        child: SizedBox(
                          child: FutureBuilder(
                            future: supaBaseHandler.readData(
                                MakeupArtist.TABLE_NAME, context),
                            builder: (_, snapshot) {
                      ...
                      ElevatedButton(
                        onPressed: () {
                          if (nome.isNotEmpty) {
                            MakeupArtist myMakeupArtist = MakeupArtist(
                            ...
                            supaBaseHandler.addData(
                              MakeupArtist.TABLE_NAME,
                              myMakeupArtist.toMap(),
                              context,
                            );
