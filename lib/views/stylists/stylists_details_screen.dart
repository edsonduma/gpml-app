...
class StylistsDetailsScreen extends AbstractScreenModel {
  var dataModel;

  StylistsDetailsScreen({super.key});
  StylistsDetailsScreen.setModel({super.key, required this.dataModel});
