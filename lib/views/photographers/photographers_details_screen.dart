...
class PhotographersDetailsScreen extends AbstractScreenModel {
  var dataModel;

  PhotographersDetailsScreen({super.key});
  PhotographersDetailsScreen.setModel({super.key, required this.dataModel});
