...
class PhotographersCreateScreen extends StatefulWidget {
  const PhotographersCreateScreen({super.key});

  @override
  State<PhotographersCreateScreen> createState() =>
      _PhotographersCreateScreenState();
}

class _PhotographersCreateScreenState extends State<PhotographersCreateScreen> {
                  ...
                  child: Column(
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          if (nome.isNotEmpty) {
                            Photographer myPhotographer = Photographer(
                            ...
                            supaBaseHandler.addData(
                              Photographer.TABLE_NAME,
                              myPhotographer.toMap(),
                              context,
                            );
